<template>
  <div :class="{'hidden': (activeTab != 'database')}" class="w-full mb-8">
    ...
    <div class="">
        ...
        <div class="p-4">
          <div class="p-4">
            ...
            <div v-if="files.length">
              ...
              <select v-model="filename" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4">
      ...
      <div @click="closeModal" :class="{'hidden': !modalShown}" class="h-screen w-screen fixed pin bg-grey-darkest opacity-25"></div>
    </div>
  </div>  
</template>
