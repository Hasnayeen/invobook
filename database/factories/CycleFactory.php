...
$factory->define(App\Models\Cycle::class, function (Faker\Generator $faker) {
    ...
    switch ($cyclable_type) {
        case 'office':
            $cyclable_id = factory(App\Models\Office::class)->create()->id;
            break;
        case 'team':
            $cyclable_id = factory(App\Models\Team::class)->create()->id;
            break;
        case 'project':
            $cyclable_id = factory(App\Models\Project::class)->create()->id;
            break;
        default:
